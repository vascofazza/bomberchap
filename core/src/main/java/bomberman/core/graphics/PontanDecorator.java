...
import bomberman.core.logic.enemy.EnemyPontan;
import bomberman.core.util.Constants;

/**
 * The decorator associated to {@link EnemyPontan}.
 * 
 * @author Federico Scozzafava
 * @see http://en.wikipedia.org/wiki/Decorator_pattern
 * @see http://bomberman.wikia.com/wiki/Pontan
 */
public class PontanDecorator extends EnemyPontan implements GfxObject
{
	...
	private static Sprite dying = new Sprite(
			DecoratedEntityEngine.getTexture("pontanDying"), false);
	
	/**
	 * The idle {@link Sprite}.
	 */
	private static Sprite idle = new Sprite(
			DecoratedEntityEngine.getTexture("pontanIdle"), true);
	...
	/**
	 * Instantiates a new {@link EnemyPontan} entity decorator together with its logic entity.
	 * 
	 * @param d
	 *            the {@link DecoratedWorld}
	 * @param c
	 ...
	 */
	public PontanDecorator(DecoratedWorld d, Block c)
	{
	...
	/* (non-Javadoc)
	 * @see bomberman.core.logic.enemy.EnemyPontan#die()
	 */
	@Override
	public void die()
	{
